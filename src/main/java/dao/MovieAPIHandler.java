...
public class MovieAPIHandler {
    ...
    public List<dto.MovieDTO> getRecommendedMovies(String likeGenreIds, String dislikeGenreIds) {
    	...
    	List<dto.MovieDTO> movieList = new ArrayList<>();
        ...
        try {
            ...
            if (responseCode == 200) { // 성공한 경우
                ...
                // JSON -> DTO 객체
                Gson gson = new Gson();
                dto.MovieResponseDTO responseData = gson.fromJson(sb.toString(), dto.MovieResponseDTO.class);
